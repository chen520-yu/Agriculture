...
public class HttpsUtil {
    ...
    public void initSSLConfigForTwoWay() throws Exception {
        ...
        //ClassPathResource pkcsresource = new ClassPathResource("cert/outgoing.CertwithKey.pkcs12");
        ClassPathResource jksresource = new ClassPathResource("cert/ca.jks");

		/*KeyStore selfCert = KeyStore.getInstance("pkcs12");
		selfCert.load(pkcsresource.getInputStream(),
        ...
        caCert.load(jksresource.getInputStream(), "Huawei@123".toCharArray());
